...
class Configuration(object):
    ...
    def getCryptedDirs2Backup(self):
        if self.config['cryptedDirs2Backup'] is None:
            return []
        else:
            return self.config['cryptedDirs2Backup']
   
    def getCryptKey(self):
        if self.config['cryptKey'] is None:
            return "RIEN"
        else:
            return self.config['cryptKey']      
